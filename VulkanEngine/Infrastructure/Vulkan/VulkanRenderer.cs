...
namespace VulkanEngine.Infrastructure.Vulkan;
...
public unsafe class VulkanRenderer : IRenderer
{
    ...
    public VulkanRenderer(WindowManager windowManager, EngineConfig config)
    {
    ...
    private void UpdateUniformBuffers(Scene scene)
    {
    ...
    private void CreateBuffers(Scene scene)
    {
        CreateCameraBuffer();
    ...
    private void CreateLightBuffer(Scene scene)
    {
    ...
    private void CreateTriangleBuffer(Scene scene)
    {
        ...
        if (triangles.Length == 0)
        {
            triangles = new[] { new Triangle(
                ...
                new Vector3(1, 0, 0),
                new Vector3(0, 1, 0),
                new VulkanEngine.Core.Math.Color(1, 0, 0)
            )};
        }
